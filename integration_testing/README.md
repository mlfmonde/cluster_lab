...
+        self.cli = DockerClient(base_url="unix:///home/pverkest/anybox/clients/MLF/hebergement/cluster_lab/integration_testing/../docker.sock")
...
ssh -nNT -L $(pwd)/docker.sock:/var/run/docker.sock  mlf@192.168.122.45
...
```bash
py.test  --hosts=mlf@192.168.122.45 test_infra.py 
